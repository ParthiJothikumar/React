...
from app.constants import JOB_RUNNING
...
class ConversationRepository(BaseRepository):
    ...
    _SQL_JOB = (
        "SELECT job_id, job_status, job_message, job_baseline "
    ...
    def start_job(
        ...
        self._cursor().execute(
            ...
            "job_output = NULL, job_baseline = ?, updated_at = ? "
    ...
    def update_job_message(self, user_id: str, conv_id: str, message: str) -> None:
        """Store the latest user-facing line while the job is still running."""
        self._cursor().execute(
