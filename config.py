...
class Settings:
    ...
    def __init__(self, env: Optional[Mapping[str, str]] = None):
        ...
        # timer (see reaper/). Whichever gets there first wins -- the compare-and-swap in
        # advance_after_job() makes that safe.
        #
        ...
        # polling every ~30s keeps updated_at fresh, so an actively-watched job is
